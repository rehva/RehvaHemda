     ...
     var methods = {
             ...
             for (var i = 0, field_errors = 0; i < rules.length; i++) {
                 ...
                 switch (rules[i]) {
                     ...
                     case "minSize":
                         ...
                         break;
                     case "PostojilKorisnik":
                         errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._PostojilKorisnik);
                         break;
                     case "maxSize":
         ...
         */
         ...
         _validityProp: {
             ...
             "PostojilKorisnik": "range-underflow",
         ...
         */
         ...
         _PostojilKorisnik: function (field, rules, i, options) {
             var tmp = 0;
             if (1 > 0) {
                 var rule = options.allrules.PostojilKorisnik;
                 return rule.alertText + tmp;
             }
         },
         /**
